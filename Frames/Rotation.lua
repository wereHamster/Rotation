...
function FactoryInterface:Create()
  ...
  frame.Bar:SetPoint("LEFT", frame.Icon[2], "RIGHT", 1, 0)
  frame.Bar:SetPoint("RIGHT", frame, "RIGHT", -3, 0)

  function frame.setAction(idx, action)
    action:ClearAllPoints()
    action:SetPoint("TOPLEFT", frame, "TOPLEFT", (idx - 1) * 40 + 3, -2)
  end

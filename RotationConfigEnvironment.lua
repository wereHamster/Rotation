...
RotationConfigEnvironment = {
  ...
  ["buffStacks"] = function(name) local n, r, i, count = UnitBuff("player", name); if count == nil then return 0 else return count end; end,
  ...
  ["cooldownRemaining"] = function(name) local s, d = GetSpellCooldown(name); if d == 0 then return 0 else return (s + d - GetTime()) end; end,
